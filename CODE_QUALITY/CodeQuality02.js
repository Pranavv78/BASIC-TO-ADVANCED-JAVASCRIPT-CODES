...
--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    IMP :  The assert keyword lets you test if a condition in your code returns True, if not, the program will raise an AssertionError. 
           You can write a message to be written if the code returns False, check the example below.

           Assert is a statement that helps detect logical errors and invalid assumptions in code. It can also be used to catch bugs in code.
...
--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    IMP:- Development of “pow”: the spec:
...
--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    IMP:  For the future, let’s note that there are more high-level test-runners, like karma and others, that make it easy to autorun many different tests.
...
---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    THE RESULT  : As we could expect, the second test failed. Sure, our function always returns 8, while the assert expects 81.
...
--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    RESULT : ALL CASES ARE TRUE.
----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
    Nested describe:

    We’re going to add even more tests. But before that let’s note that the helper function makeTest and for should be grouped together.
