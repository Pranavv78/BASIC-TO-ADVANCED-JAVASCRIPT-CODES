/*
 ...
 ==================== 
     ...
     IMP: 
      # THE FUNCTION EXPRESSION IS THE ANOTHER WAY TO CREATE A NEW FUNCTION.It allows us to create a new function in the middle of any expression.
    ...
    VIMP : Line (2) copies it into the variable func. Please note again: there are no parentheses after sayHi. If there were, then func = sayHi() would write the result of the call sayHi() into func, not the function sayHi itself.
